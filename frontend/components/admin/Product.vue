        ...
        <div class="mt-8 flex justify-start items-center gap-8">
            <div class="" v-for="(product, index) in meData" :key="index">
                <div class="bg-white h-auto w-[220px] p-4 rounded-lg">
                    <img class="w-[140px] mx-auto h-auto" :src="`http://localhost:3333/image/${product.image}`" alt=""/>
                    <div class="mt-3 flex flex-col gap-1">
                        ...
                        <div class="mt-2 flex items-center gap-2">
                            <button class="font-poppins_medium text-white bg-blue-500 p-1 cursor-pointer rounded-md">
