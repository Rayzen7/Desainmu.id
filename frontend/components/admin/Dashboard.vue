...
<template>
    <section>
        ...
        <div class="flex justify-start mt-8 items-center gap-6">
            <div class="flex text-black group hover:-translate-y-2 hover:scale-105 duration-300 justify-between relative flex-col bg-white drop-shadow-md w-full h-[130px] rounded-md p-4 px-6 cursor-pointer">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-[16px] font-poppins_medium group-hover:text-primary duration-300">Product Total</p>
                </div>
                <div class="flex justify-end items-center gap-2">
                    <p class="text-[30px] ml-auto font-poppins_medium group-hover:text-primary duration-300">{{ meData?.productCount }}</p> 
            ...
            <div class="flex text-black group hover:-translate-y-2 hover:scale-105 duration-300 justify-between relative flex-col bg-white drop-shadow-md w-full h-[130px] rounded-md p-4 px-6 cursor-pointer">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-[16px] font-poppins_medium group-hover:text-primary duration-300">Order Total</p>
                </div>
                <div class="flex justify-end items-center gap-2">
                    <p class="text-[30px] ml-auto font-poppins_medium group-hover:text-primary duration-300">{{ meData?.transactionCount }}</p> 
            ...
            <div class="flex text-black group hover:-translate-y-2 hover:scale-105 duration-300 justify-between relative flex-col bg-white drop-shadow-md w-full h-[130px] rounded-md p-4 px-6 cursor-pointer">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-[16px] font-poppins_medium group-hover:text-primary duration-300">Review Total</p>
                </div>
                <div class="flex justify-end items-center gap-2">
                    <p class="text-[30px] ml-auto font-poppins_medium group-hover:text-primary duration-300">{{ meData?.reviewCount }}</p> 
            ...
            <div class="flex text-black group hover:-translate-y-2 hover:scale-105 duration-300 justify-between relative flex-col bg-white drop-shadow-md w-full h-[130px] rounded-md p-4 px-6 cursor-pointer">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-[16px] font-poppins_medium group-hover:text-primary duration-300">Total Transaction</p>
                </div>
                <div class="flex justify-end items-center gap-2">
                    <p class="text-[24px] ml-auto font-poppins_medium group-hover:text-primary duration-300">{{ RupiahFormat(meData?.transactionTotal || 0) }}</p> 
        ...
        <div class="mt-12">
            <div class="flex flex-col gap-1">
                <h1 class="text-[24px] font-poppins_medium">Report the Order Transaction</h1>
                <p class="text-[20px] font-poppins_regular">{{ RupiahFormat(meData?.transactionTotal || 0) }}</p>
            </div>
